    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <SectionCard variant="solid">
          ...
          <p className="text-xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">$0.00</p>
        </SectionCard>
        <SectionCard variant="solid">
          <span className="text-xs text-muted-foreground font-semibold">31-60 Days</span>
          <p className="text-xl font-bold text-blue-600 dark:text-blue-400 mt-1">$0.00</p>
        </SectionCard>
        <SectionCard variant="solid">
          <span className="text-xs text-muted-foreground font-semibold">61-90 Days</span>
          <p className="text-xl font-bold text-amber-600 dark:text-amber-400 mt-1">$0.00</p>
        </SectionCard>
        <SectionCard variant="solid">
