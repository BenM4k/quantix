...
export default async function ProductMasterPage({
  ...
  const taxRateId = typeof resolvedSearchParams.taxRateId === "string" ? resolvedSearchParams.taxRateId : undefined;
  ...
  const stockSummaries: Record<string, { quantityOnHand: string; averageCost: string }> = {};
